...
# Use a small LoRA adapter available in the test environment
LORA_PATH = os.environ.get(
    "SGLANG_TEST_LORA_PATH",
    "/data/hf_cache/models--nvidia--llama-3.1-nemoguard-8b-topic-control/snapshots/5ce438e7119061c809e9da819beb5b9287104230/",
)
