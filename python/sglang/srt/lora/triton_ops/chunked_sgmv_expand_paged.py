...
def chunked_sgmv_lora_expand_forward_paged(
    ...
    # BLOCK_K must be >= 16 (tl.dot minimum) and at least PR
    # Extra K elements beyond PR are zero-padded via mask.
    BLOCK_K = _next_power_of_2(max(PR, 16))
    # Use a reasonable BLOCK_N for the output dimension
    BLOCK_N = 128
