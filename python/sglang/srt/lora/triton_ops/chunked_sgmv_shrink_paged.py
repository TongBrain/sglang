...
def chunked_sgmv_lora_shrink_forward_paged(
    ...
    # Block shapes
    BLOCK_M = _next_power_of_2(batch_info.max_len)
    # Triton tl.arange requires power-of-two ranges.  Keep N_PER_PAGE as the
    # real stride/output width and use BLOCK_N only for the compute tile.
    BLOCK_N = _next_power_of_2(N_PER_PAGE)
    # Use a reasonable BLOCK_K for the input-dim iteration.
    BLOCK_K = 64  # tuned for input_dim ~ 2560-4096
